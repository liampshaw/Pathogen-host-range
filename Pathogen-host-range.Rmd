...
The following code chunk contains library requirements and defines two useful functions:
...
While humans are important, we want to think about pathogen range etc. after removing them from the database and the host tree. We recalculate PHB after doing this. 
...
```{r Figure_PHB_histogram, cache=cachedata}
